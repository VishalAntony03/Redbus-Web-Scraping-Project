...
web=option_menu(menu_title="Redbus Web Scraping Project",
                options=["State Bus and Transport"],
                orientation="horizontal"
                )

# States and Routes page setting
if web == "State Bus and Transport":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = mysql.connector.connect(host="localhost", user="root", password="vishal", database="REDBUSDETAIL")
